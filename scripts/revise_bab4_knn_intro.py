...
def insert_paragraph_after(paragraph):
    ...
    return paragraph._parent.add_paragraph()._p.addprevious(new_p)
...
def clone_paragraph_style(source_paragraph, target_paragraph):
    ...
    target_paragraph.paragraph_format.first_line_indent = (
        source_paragraph.paragraph_format.first_line_indent
    )
