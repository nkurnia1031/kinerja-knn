                            ...
                            <div class="card-body">
                                <table class="table table-sm">
                                    ...
                                    <tbody v-if="detailPerhitungan && detailPerhitungan.k_nearest">
                                        <tr v-for="(n, idx) in detailPerhitungan.k_nearest" :key="n.training_id || idx">
                                            <td>@{{ n.ranking || (idx + 1) }}</td>
                                            <td>
                                                <div class="font-weight-bold">@{{ n.nama_training }}</div>
                                                <small class="text-muted d-block">Periode: @{{ n.periode_training || '-' }}</small>
                                            </td>
                                    ...
                                    <tbody v-else-if="selectedKaryawan.k_nearest">
                                        <tr v-for="(n, idx) in selectedKaryawan.k_nearest" :key="n.training_id || n.id || idx">
                                            <td>@{{ n.ranking || (idx + 1) }}</td>
                                            <td>
                                                <div class="font-weight-bold">@{{ n.nama }}</div>
                                                <small class="text-muted d-block">Periode: @{{ n.nama_periode || '-' }}</small>
                                            </td>
