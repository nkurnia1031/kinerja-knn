            ...
            <div class="card bg-gradient-primary text-white shadow">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <h4 class="mb-1">Rekap Penilaian Kinerja Anda</h4>
                        ...
                        <div class="col-md-4">
                            <div class="card bg-light">
                                <div class="card-body text-center">
                                    ...
                                    <span class="d-inline-block ml-1 mt-1" :class="'badge badge-' + getKlasifikasiClass(detailPenilaian.klasifikasi_knn)">
                                        KNN: @{{ detailPenilaian.klasifikasi_knn || '-' }}
                                    </span>
                                    <div v-if="detailPenilaian.knn_confidence" class="small text-muted mt-2">
                                        Confidence: @{{ detailPenilaian.knn_confidence }}%
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <td style="width: 200px;">
                                        <div class="progress" style="height: 20px;">
                                            <div class="progress-bar" role="progressbar" 
                                                ...
                                                :class="'bg-' + getKlasifikasiClass(detail.progress >= 90 ? 'Sangat Baik' : detail.progress >= 80 ? 'Baik' : detail.progress >= 70 ? 'Cukup' : 'Kurang')">
                                                @{{ detail.progress }}%
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-md-3 text-center">
                                            ...
                                            <span class="d-inline-block ml-1 mt-1" :class="'badge badge-' + getKlasifikasiClass(penilaian.klasifikasi_knn)">
                                                KNN: @{{ penilaian.klasifikasi_knn || '-' }}
                                            </span>
                                        </div>
                                        <div class="col-md-3">
