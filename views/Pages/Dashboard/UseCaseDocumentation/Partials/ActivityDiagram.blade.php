@php
    ...
    $activityDescriptions = [
        1 => '<i>Activity Diagram</i> <i>Login</i> merupakan gambaran alur kerja yang digunakan oleh pengguna dalam melakukan autentikasi untuk mengakses sistem sebagaimana ditunjukkan pada gambar di bawah.',
        4 => '<i>Activity Diagram</i> <i>Data Karyawan</i> merupakan gambaran alur kerja yang digunakan oleh <i>admin</i> dalam melakukan penambahan, penghapusan, dan pembaruan data karyawan sebagaimana ditunjukkan pada gambar di bawah.',
    ];
    $activityDescription = $activityDescriptions[$useCase['no']] ?? ('<i>Activity Diagram</i> ' . $title . ' merupakan gambaran alur kerja yang digunakan oleh pengguna dalam menjalankan proses ' . strtolower($title) . ' sebagaimana ditunjukkan pada gambar di bawah.');
    $pumlLines = [
        '@startuml',
